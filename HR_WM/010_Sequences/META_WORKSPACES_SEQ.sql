/* This anonymous block creates a sequence named META_WORKSPACES_SEQ
...
DECLARE
   v_sequence_name user_sequences.sequence_name%TYPE := 'META_WORKSPACES_SEQ';
BEGIN
   ...
   LOOP
      EXECUTE IMMEDIATE q'[
                       CREATE SEQUENCE META_WORKSPACES_SEQ 
                              MINVALUE 1 
